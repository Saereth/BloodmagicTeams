package com.breakinblocks.neovitaeteams.ui;
...
import com.breakinblocks.neovitaeteams.network.BindingModePayload;
...
public class BindingModeScreen extends BaseScreen {
    ...
    public Component getTitle() {
        return Component.translatable("gui.neovitaeteams.binding_mode.title");
    }
    ...
    private class TitlePanel extends Panel {
        ...
        public void drawBackground(GuiGraphics graphics, Theme theme, int x, int y, int w, int h) {
            theme.drawString(graphics,
                    Component.translatable("gui.neovitaeteams.binding_mode.title"),
                    x + w / 2, y + 5, Theme.CENTERED);
            theme.drawString(graphics,
                    Component.translatable("gui.neovitaeteams.binding_mode.team", teamName),
    ...
    private class BindingButton extends Button {
        ...
        public Component getTitle() {
            return mode == BindingMode.PERSONAL
                    ? Component.translatable("gui.neovitaeteams.binding_mode.personal")
                    : Component.translatable("gui.neovitaeteams.binding_mode.team_button");
        }

        @Override
        public void addMouseOverText(TooltipList list) {
            if (mode == BindingMode.PERSONAL) {
                list.add(Component.translatable("gui.neovitaeteams.binding_mode.personal.tooltip"));
            } else {
                list.add(Component.translatable("gui.neovitaeteams.binding_mode.team.tooltip"));
            }
        }
        ...
        public void onClicked(MouseButton button) {
            if (button.isLeft()) {
                ...
                closeGui();
                NeoVitaeTeams.LOGGER.debug("Selected binding mode: {} (dontAsk: {})", mode, dontAskAgain);
            }
        }
    ...
    private class CheckboxButton extends Button {
        ...
        @Override
        public Component getTitle() {
            return Component.translatable("gui.neovitaeteams.binding_mode.dont_ask");
        }

        @Override
        public void addMouseOverText(TooltipList list) {
            list.add(Component.translatable("gui.neovitaeteams.binding_mode.dont_ask.tooltip"));
        }
    ...
    private class WarningPanel extends Panel {
        ...
        public void drawBackground(GuiGraphics graphics, Theme theme, int x, int y, int w, int h) {
            if (dontAskAgain) {
                Component warning = Component.translatable("gui.neovitaeteams.binding_mode.reset_hint")
