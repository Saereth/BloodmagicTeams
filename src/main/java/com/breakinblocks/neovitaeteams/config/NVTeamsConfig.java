package com.breakinblocks.neovitaeteams.config;

import net.neoforged.neoforge.common.ModConfigSpec;

public class NVTeamsConfig {
    ...
    static {
        BUILDER.comment("Neo Vitae Teams Configuration");
        ...
        ALLOW_BINDING_MODE_COMMAND = BUILDER
                .comment("Allow players to use /nvteams bindingmode command to set their default binding mode")
